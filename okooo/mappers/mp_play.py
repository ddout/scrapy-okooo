    ...
    def save(self, **kwargs):
        ...
        if old == None:
            sql = "insert into okooo.play(id, play_urls, area, country, match_name, " \
                  ...
                  " team_vis, half_home, half_vis, full_home, full_vis,play_result, play_result_detail, odds_info) " \
                  ...
                  " %(full_vis)s, %(play_result)s, %(play_result_detail)s, %(odds_info)s);"
            ...
            sql = "update okooo.play set " \
                  ...
                  " play_result_detail=%(play_result_detail)s,"\
